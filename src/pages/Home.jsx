...
<Link className=" bg-cyan-400 border rounded-md px-6 py-1.5" to={DiseaseSearch}>
            Get Search
          </Link>
        </div>
      ...
      <div className="hero min-h-screen px-4">
        <div className="hero-content flex-col lg:flex-row">
          ...
          <div className="px-32">
            ...
            <button className="btn bg-cyan-300 hover:bg-cyan-900 hover:text-white">Get Started</button>
          </div>
        </div>
      </div>
      <Article />
